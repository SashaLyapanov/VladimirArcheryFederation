...
CREATE TABLE applications (
                              ...
                              bow_type_id int NOT NULL,
                              payment bool,
                              FOREIGN KEY (sportsman_id) REFERENCES users (id),
                              FOREIGN KEY (competition_id) REFERENCES competitions (id),
                              FOREIGN KEY (bow_type_id) REFERENCES bow_types (id)
);
...
DROP TABLE IF EXISTS Competition_BowType;
CREATE TABLE Competition_BowType (
                                     competiiton_id int NOT NULL,
                                     bow_type_id int NOT NULL,
                                     FOREIGN KEY (competiiton_id) REFERENCES competitions (id),
                                     FOREIGN KEY (bow_type_id) REFERENCES bow_types (id)
);
