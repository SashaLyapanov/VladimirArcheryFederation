...
--таблица разрядов
DROP TABLE IF EXISTS sports_tytles;
...
DROP TABLE IF EXISTS coache_bowTypes;
CREATE TABLE coach_bowTypes (
...
DROP TABLE IF EXISTS competition_bowType;
CREATE TABLE competiiton_bowType (
...
DROP TABLE IF EXISTS your_exercises;
CREATE TABLE your_exercises (
    id int GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY UNIQUE NOT NULL,
    sportsman_id int NOT NULL,
...
DROP TABLE IF EXISTS yourExercises_sessionExercises;
CREATE TABLE yourExercises_sessionExercises (
                                            your_exercise int NOT NULL,
                                            session_exercise_id int NOT NULL,
                                            FOREIGN KEY (your_exercise) REFERENCES your_exercises (id),
                                            FOREIGN KEY (session_exercise_id) REFERENCES session_exercises (id)
);
