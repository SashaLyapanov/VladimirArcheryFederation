...
- Backand: основной backand-сервис на Java + Spring Boot
- Frontend: (https://github.com/SashaLyapanov/VladimirArcheryFederationFront) клиентское SPA-приложение на React
- DB: PostgreSQL
